...
document.getElementById(
  "header"
).innerHTML = ` <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
<div class="container">
  <a class="navbar-brand" href="index.html">Librerías Jenny</a>
  ...
  <!--<div class="collapse navbar-collapse" id="collapsibleNavId">
      ...
      <!-- <form class="d-flex my-2 my-lg-0">
        ...
        <form class="d-flex my-2 my-lg-0" name="busqueda" method="POST" action="" id="formularioBusqueda">
            <input class="form-control me-sm-2" type="text" placeholder="Libro, autor o editorial" name="textoBuscado">
